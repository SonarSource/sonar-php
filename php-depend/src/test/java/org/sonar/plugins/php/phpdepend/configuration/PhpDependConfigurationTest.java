...
public class PhpDependConfigurationTest {
	...
	public void shouldReturnDefaultReportFileWithDefaultPath() {
		...
		when(
				configuration.getString(PhpDependConfiguration.REPORT_FILE_NAME_PROPERTY_KEY,
						PhpDependConfiguration.DEFAULT_REPORT_FILE_NAME)).thenReturn(
				PhpDependConfiguration.DEFAULT_REPORT_FILE_NAME);
		when(
				configuration.getString(PhpDependConfiguration.REPORT_FILE_RELATIVE_PATH_PROPERTY_KEY,
						PhpDependConfiguration.DEFAULT_REPORT_FILE_PATH)).thenReturn(
	...
	public void shouldReturnCustomReportFileWithCustomPath() {
		...
		when(
				configuration.getString(PhpDependConfiguration.REPORT_FILE_NAME_PROPERTY_KEY,
						PhpDependConfiguration.DEFAULT_REPORT_FILE_NAME)).thenReturn("pdepend.summary.xml");
		when(
				configuration.getString(PhpDependConfiguration.REPORT_FILE_RELATIVE_PATH_PROPERTY_KEY,
						PhpDependConfiguration.DEFAULT_REPORT_FILE_PATH)).thenReturn("reports");
		when(project.getConfiguration()).thenReturn(configuration);
	 ...
	 * 
	 * @param isOsWindows the is os windows
	 * @param path the path
