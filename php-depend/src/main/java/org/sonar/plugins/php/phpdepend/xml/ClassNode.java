...
public final class ClassNode {
	 ...
	 */
	public ClassNode(final double codeLinesNumber, final double commentLineNumber, final double linesNumber,
	    final double complexity, final double methodNumber, final List<MethodNode> methodes) {
		super();
	 ...
	 * Sets the classes.
	 * 
	 * @param methodes the new classes
	 */
	 ...
	 * 
	 * @param methodNumber the new method number
	 */
