...
@Properties({
  ...
  @Property(key = PhpDependConfiguration.PDEPEND_REPORT_FILE_NAME_PROPERTY_KEY,
      defaultValue = PhpDependConfiguration.PDEPEND_DEFAULT_REPORT_FILE_NAME, name = "PhpDepend log file name",
      description = "The php depend log file name.", project = true),
  ...
  @Property(key = PhpDependConfiguration.PDEPEND_EXCLUDE_PACKAGE_KEY,
      defaultValue = PhpDependConfiguration.PDEPEND_DEFAULT_EXCLUDE_PACKAGES,
  ...
  @Property(key = PhpDependConfiguration.PDEPEND_BAD_DOCUMENTATION_KEY,
      defaultValue = PhpDependConfiguration.PDEPEND_DEFAULT_BAD_DOCUMENTATION, name = "The project documentation is clean.",
      description = "If set to true, documentation analysis will be skipped", project = true),
  @Property(key = PhpDependConfiguration.PDEPEND_WITHOUT_ANNOTATION_KEY,
      defaultValue = PhpDependConfiguration.PDEPEND_DEFAULT_WITHOUT_ANNOTATION,
      name = "Packages that will be excluded from the analysis process.",
      description = "A list of comma separated packages that will be excluded from analysis", project = true),
  ...
  @Property(key = PhpDependConfiguration.PDEPEND_ANALYZE_ONLY_PROPERTY_KEY,
      defaultValue = PhpDependConfiguration.PDEPEND_DEFAULT_ANALYZE_ONLY, name = "Should the plugin only parse analyzis report.",
      description = PhpDependConfiguration.PDEPEND_ANALYZE_ONLY_DESCRIPTION, project = true),
