...
public enum PHPGrammar implements GrammarRuleKey {
  ...
  public static void expression(LexerfulGrammarBuilder b) {
    ...
    b.rule(STATIC_UNARY_EXPR).is(b.firstOf(
      ...
      STATIC_SCALAR_VALUE)).skipIfOneChild();

    b.rule(STATIC_CONCATENATION_EXPR).is(STATIC_UNARY_EXPR, b.zeroOrMore(DOT, STATIC_UNARY_EXPR)).skipIfOneChild();
    b.rule(STATIC_MULTIPLICATIVE_EXPR).is(STATIC_CONCATENATION_EXPR, b.zeroOrMore(MULIPLICATIVE_OPERATOR, STATIC_CONCATENATION_EXPR)).skipIfOneChild();
    b.rule(MULIPLICATIVE_OPERATOR).is(b.firstOf(STAR, DIV, MOD));
    b.rule(STATIC_ADDITIVE_EXPR).is(STATIC_MULTIPLICATIVE_EXPR, b.zeroOrMore(ADDITIVE_OPERATOR, STATIC_MULTIPLICATIVE_EXPR)).skipIfOneChild();
    b.rule(ADDITIVE_OPERATOR).is(b.firstOf(PLUS, MINUS));
    b.rule(STATIC_SHIFT_EXPR).is(STATIC_ADDITIVE_EXPR, b.zeroOrMore(SHIFT_OPERATOR, STATIC_ADDITIVE_EXPR)).skipIfOneChild();
    b.rule(SHIFT_OPERATOR).is(b.firstOf(SL, SR));
    b.rule(STATIC_RELATIONAL_EXPR).is(STATIC_SHIFT_EXPR, b.zeroOrMore(RELATIONAL_OPERATOR, STATIC_SHIFT_EXPR)).skipIfOneChild();
    b.rule(RELATIONAL_OPERATOR).is(b.firstOf(LE, GE, LT, GT));
    b.rule(STATIC_EQUALITY_EXPR).is(STATIC_RELATIONAL_EXPR, b.zeroOrMore(EQUALITY_OPERATOR, STATIC_RELATIONAL_EXPR)).skipIfOneChild();
    ...
    b.rule(STATIC_BITEWISE_AND_EXPR).is(STATIC_EQUALITY_EXPR, b.zeroOrMore(AND, STATIC_EQUALITY_EXPR)).skipIfOneChild();
    b.rule(STATIC_BITEWISE_XOR_EXPR).is(STATIC_BITEWISE_AND_EXPR, b.zeroOrMore(XOR, STATIC_BITEWISE_AND_EXPR)).skipIfOneChild();
    b.rule(STATIC_BITEWISE_OR_EXPR).is(STATIC_BITEWISE_XOR_EXPR, b.zeroOrMore(OR, STATIC_BITEWISE_XOR_EXPR)).skipIfOneChild();
    b.rule(STATIC_LOGICAL_AND_EXPR).is(STATIC_BITEWISE_OR_EXPR, b.zeroOrMore(LOGICAL_AND_OPERATOR, STATIC_BITEWISE_XOR_EXPR)).skipIfOneChild();
    b.rule(LOGICAL_AND_OPERATOR).is(b.firstOf(ANDAND, PHPKeyword.AND));
    b.rule(STATIC_LOGICAL_XOR_EXPR).is(STATIC_LOGICAL_AND_EXPR, b.zeroOrMore(PHPKeyword.XOR, STATIC_LOGICAL_AND_EXPR)).skipIfOneChild();
    b.rule(STATIC_LOGICAL_OR_EXPR).is(STATIC_LOGICAL_XOR_EXPR, b.zeroOrMore(LOGICAL_OR_OPERATOR, STATIC_LOGICAL_XOR_EXPR)).skipIfOneChild();
    b.rule(LOGICAL_OR_OPERATOR).is(b.firstOf(OROR, PHPKeyword.OR));
    b.rule(STATIC_CONDITIONAL_EXPR).is(STATIC_LOGICAL_OR_EXPR, b.optional(QUERY, b.optional(STATIC_SCALAR_VALUE), COLON, STATIC_SCALAR_VALUE)).skipIfOneChild();
    b.rule(STATIC_OPERATION_EXPR).is(b.firstOf(
      b.sequence(LPARENTHESIS, STATIC_CONDITIONAL_EXPR, RPARENTHESIS),
      STATIC_LOGICAL_OR_EXPR)).skipIfOneChild();
    ...
    b.rule(CONDITIONAL_EXPR).is(LOGICAL_OR_EXPR, b.optional(QUERY, b.optional(ASSIGNMENT_EXPR), COLON, LOGICAL_OR_EXPR)).skipIfOneChild();
