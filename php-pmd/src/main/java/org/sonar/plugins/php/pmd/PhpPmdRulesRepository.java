...
public class PhpPmdRulesRepository implements RulesRepository<Php>, ConfigurationExportable, ConfigurationImportable {
	 ...
	 * 
	 * @param xmlModules the xml modules
	 * 
	 * @return the string
	 */
	 ...
	 * 
	 * @param ruleset the profile ruleset
	 * @param activeRules the constructed list
	 * @param rules the rules from initial ruleset
	 */
	...
	public final RulesProfile buildProfile(String name, String path) {
		...
		try {
			...
			buildActiveRulesFromRuleset(buildRulesetFromXml(IOUtils.toString(input, "UTF-8")), activeRules,
	 ...
	 * @param buildModuleTreeFromXml the build module tree from xml
	 */
	 ...
	 * 
	 * @see org.sonar.api.rules.ConfigurationImportable#importConfiguration(java.lang.String,
	 * java.util.List)
	 */
