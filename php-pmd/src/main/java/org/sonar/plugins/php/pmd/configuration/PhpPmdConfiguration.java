...
/**
 * The PhpPmd configuration class. 
 * It handles report file path and name with default options
 */
public class PhpPmdConfiguration extends PhpPluginAbstractConfiguration {
	...
	/**
	 * @see
	 * org.sonar.plugins.php.core.configuration.PhpPluginAbstractConfiguration
	 * #getArgumentLineKey()
	 */
	@Override
	...
	/**
	 * @see
	 * org.sonar.plugins.php.core.configuration.PhpPluginAbstractConfiguration#getCommandLine()
	 */
	@Override
