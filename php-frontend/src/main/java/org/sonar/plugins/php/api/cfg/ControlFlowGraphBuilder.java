...
class ControlFlowGraphBuilder {
  ...
  private PhpCfgBlock build(Tree tree, PhpCfgBlock currentBlock) {
    return switch (tree.getKind()) {
      ...
      case GLOBAL_STATEMENT, STATIC_STATEMENT, UNSET_VARIABLE_STATEMENT, FUNCTION_DECLARATION, USE_STATEMENT, GROUP_USE_STATEMENT, CONSTANT_DECLARATION,
        NAMESPACE_STATEMENT, INLINE_HTML, EXPRESSION_STATEMENT, ECHO_TAG_STATEMENT -> {
