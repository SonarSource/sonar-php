...
/**
 * Abstract php plugin configuration. 
...
public abstract class PhpPluginAbstractConfiguration {
	...
	public File getReportFile() {
		return new File(project.getFileSystem().getBuildDir(), new StringBuilder().append(reportFileRelativePath).append(
				File.separator).append(reportFileName).toString());
	}
	 ...
	 * 
	 * @param aProject the project to analyze
	 */
