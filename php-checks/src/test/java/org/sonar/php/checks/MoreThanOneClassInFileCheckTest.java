...
public class MoreThanOneClassInFileCheckTest {
  ...
  public void ko1() throws Exception {
    ...
    Foo.check(check, TestUtils.getCheckFile(TEST_DIR + "ko1.php"), ImmutableList.<PhpIssue>of(new LegacyIssue(check, message).cost(1.0)));
  }
  ...
  public void ko2() throws Exception {
    ...
    Foo.check(check, TestUtils.getCheckFile(TEST_DIR + "ko2.php"), ImmutableList.<PhpIssue>of(new LegacyIssue(check, message).cost(1.0)));
  }
  ...
  public void ko3() throws Exception {
    ...
    Foo.check(check, TestUtils.getCheckFile(TEST_DIR + "ko3.php"), ImmutableList.<PhpIssue>of(new LegacyIssue(check, message).cost(2.0)));
  }
