...
public class MoreThanOneClassInFileCheckTest {
  ...
  public void ko1() throws Exception {
    ...
    PHPCheckTest.check(check, TestUtils.getCheckFile(TEST_DIR + "ko1.php"), Collections.singletonList(new LineIssue(check, 0, message).cost(1.0)));
  }
  ...
  public void ko2() throws Exception {
    ...
    PHPCheckTest.check(check, TestUtils.getCheckFile(TEST_DIR + "ko2.php"), Collections.singletonList(new LineIssue(check, 0, message).cost(1.0)));
  }
  ...
  public void ko3() throws Exception {
    ...
    PHPCheckTest.check(check, TestUtils.getCheckFile(TEST_DIR + "ko3.php"), Collections.singletonList(new LineIssue(check, 0, message).cost(2.0)));
  }
