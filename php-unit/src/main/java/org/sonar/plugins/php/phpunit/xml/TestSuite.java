...
public final class TestSuite {
	 ...
	 * @param name the name
	 * @param file the file
	 * @param fullPackage the full package
	 ...
	 */
	public TestSuite(final String name, final String file, final String fullPackage, final String category,
	    final String packageName, final String subpackage, final String tests, final String assertions,
	    final Integer failures, final Integer errors, final double time, final List<TestSuite> testSuites,
	 ...
	 * 
	 * @param fullPackage the new full package
	 */
	 ...
	 * Sets the subpackage.
	 * 
	 * @param subpackage the new subpackage
	 */
