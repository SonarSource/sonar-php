...
public final class TestCase {
	 ...
	 * @param time the time
	 */
	public TestCase(final int assertions, final String className, final String errorMessage, final String file,
	    final int line, final String name, final String status, final String error,
	    final String failure, final double time) {
		super();
