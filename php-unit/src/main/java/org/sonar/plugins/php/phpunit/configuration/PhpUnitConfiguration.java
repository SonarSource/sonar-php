...
public class PhpUnitConfiguration extends PhpPluginAbstractConfiguration {
	...
	public static final String DEFAULT_REPORT_FILE_NAME = "punit.xml";
	...
	public static final String MAIN_TEST_CLASS_PROPERTY_KEY = "sonar.phpUnit.mainTestClass";

	/** The Constant DEFAULT_MAIN_TEST_CLASS. */
	public static final String DEFAULT_MAIN_TEST_CLASS = "/source/tests/AllTests.php";
	...
	public String getMainTestClass() {
		String reportFileName = project.getConfiguration().getString(MAIN_TEST_CLASS_PROPERTY_KEY, DEFAULT_MAIN_TEST_CLASS);
		return new File(project.getFileSystem().getBasedir(), reportFileName).getAbsolutePath();
	...
	public File getCoverageReportFile() {
		return new File(project.getFileSystem().getBuildDir(), new StringBuilder().append(getReportFileRelativePath()).append(
				File.separator).append(
				project.getConfiguration().getString(COVERAGE_REPORT_FILE_PROPERTY_KEY, DEFAULT_COVERAGE_REPORT_FILE)).toString());
	}
